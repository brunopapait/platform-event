  ...
  return (
    <div className="flex-1">
      <div className="bg-black flex justify-center flex-col">
        <div className="h-full w-full max-w-[1100px] max-h-60vh aspect-video self-center">
          <Player>
        ...
        <div className="p-8 max-w-[1100px] mx-auto">
          ...
          <div className="gap-8 mt-20 grid grid-cols-2">
            ...
            >
              ...
              <div className="py-6 leading-relaxed flex flex-col">
              ...
              <div className="h-full p-6 flex items-center">
                <CaretRight size={40} color="#81D8F7" />
              </div>
            </a>
            <a
              href=""
